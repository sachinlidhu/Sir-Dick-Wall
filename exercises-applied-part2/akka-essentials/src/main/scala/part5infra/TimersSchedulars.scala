...
object TimersSchedulars extends App {
  ...
  val system = ActorSystem("SchedularsTimerDemo")
...
/*  val routine: Cancellable = system.scheduler.scheduleAtFixedRate(1 second, 2 seconds) {
  ...
  // cancellable type means it can be cancelled
  system.schesduler.scheduleOnce(5 seconds) {
    routine.cancel()
  }*/
  /**
  ...
  val timerHeartbeatAcctor = system.actorOf(Props[TimerBasedHeartbeatActor],"timerActor")
  system.scheduler.scheduleOnce(5 seconds) {
    timerHeartbeatAcctor ! Stop
  }
}
