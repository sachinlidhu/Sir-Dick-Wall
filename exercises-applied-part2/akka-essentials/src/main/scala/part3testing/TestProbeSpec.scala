...
class TestProbeSpec extends TestKit(ActorSystem("TestProbeSpec"))
  ...
  "A master actor" should{
    ...
    "send the work to the slave actor" in {
      ...
      //interaction between the master and slave actor
...
object TestProbeSpec{
  ...
  -master sends the slave some piece of work
  -slave processes the work and replies to master
  -master aggregates thee result
  then master send the total count to the original requester
   */
